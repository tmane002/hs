...
int main(int argc, char **argv) {
    ...
    auto opt_imp_timeout = Config::OptValDouble::create(5);
...
//        HOTSTUFF_LOG_INFO("Round robin pacemaker");
//        pmaker = new hotstuff::PaceMakerRR(ec, parent_limit, opt_base_timeout->get(), opt_prop_delay->get());

    }
    else
    {
        HOTSTUFF_LOG_INFO("Round robin pacemaker with clinworker= %d",opt_clinworker->get());
        pmaker = new hotstuff::PaceMakerRR(ec, parent_limit, opt_base_timeout->get(), opt_prop_delay->get());
