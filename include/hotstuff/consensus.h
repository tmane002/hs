...
struct Proposal: public Serializable {
    ...
    void serialize(DataStream &s) const override {
        s << cluster_number << pre_amp_cluster_number << other_cluster_block_height << msg_type<< proposer
          << *blk;
        HOTSTUFF_LOG_INFO("While serializing msg_type is %d, proposer is %d",
                           msg_type,proposer);
    ...
    void unserialize(DataStream &s) override {
        ...
        HOTSTUFF_LOG_INFO("While unserializing, msg_type is %d, cluster_number is %d, _blk.get_height() is %d, other_cluster_block_height is %d, blk cache size is %d, cmd cache size is %d, proposer is %d",
